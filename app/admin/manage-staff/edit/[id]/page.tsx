...
export default function Editstaff() {
    ...
    const handlePasswordChange = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/api/admin/updatepasswords/${staffId}`,
                {
                    method: "PUT",
                    headers: {
    ...
    const handleProfileInfoUpdate = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/admin/staff/edit/${staffId}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
            ...
            setError(error instanceof Error ? error.message : "Failed to update staff data");
        } finally {
            setLoading(false);
        }
    };
            ...
            <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <button
                            onClick={() => router.push("/admin/manage-staffs")}
