...
export default function EditStudent() {
    ...
    useEffect(() => {
        ...
        const fetchStudentData = async () => {
            ...
            setError("");
            try {
                const response = await fetch(`${API_BASE_URL}/api/admin/student/${studentId}`, {
                    method: "GET",
                    headers: {
    ...
    const handlePasswordChange = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/api/admin/updatepasswords/${studentId}`,
                {
                    method: "PUT",
                    headers: {
    ...
    const handleProfileInfoUpdate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(error instanceof Error ? error.message : "Failed to update student data");
        } finally {
            setLoading(false);
        }
    };
